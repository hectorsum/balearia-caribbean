    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=17035&lang=1&conf=" + response;
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=17035&lang=1&conf=" + response + "&lastname=" + $("#lastname3").val();
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=17035&lang=1&conf=" + response + "&lastname=" + $("#lastname2").val();
            }
        }
    });
    return false;
...
var cur_conv = 1;
    ...
    $('#next-step').on('click', function(event){
        ...
        var ageBox='';
        var ageOption='';
        var today = new Date(2021,3,28);
        var aD = new Date(2021,5,10);
...
ageOption+='<option value="12">12</option>';
    ...
    function parse_rates(xml) {   
        ...
        $.ajax({
            type: "GET",            
            async: false,
            url: "/hotel_fastlink_js/17035.xml",
            dataType: "xml",
            ...
            error: function(res, textStatus, errorThrown){
                get_data('31-MAY-21','30-NOV-21', textStatus + errorThrown.substring(0, 20));
            }
        });  */

        
        if(typeof CAL_XML === "undefined"){
            get_data('31-MAY-21','30-NOV-21', "File Not Found");
        } else {
            try{
        ...
        $.ajax({
            ...
            data: {
                ...
                xStartDate: startDate?startDate:'28-APR-21',
    ...
    if ($('.travel-calendar').length > 0) {
        ...
        var temp1 = new Date(2021,5,10);
        var temp2 = new Date(2021,5,17);
var temp3 = new Date();

        var temp4 = new Date(2021,5,28);
                        ...
                        if (check_the_date(curL, unavail_v2)){
                            ...
                            if (+cur === +_selected_date) {
                                ...
                                if (stopDate!=curDate.getTime()) {
                                    if (firstTime >= 0){
$('#error_message_content').empty().append('<p class="center a95f5f">Your selection is unavailable. Please choose another date or call +1 242 3734000 for possible limited inventory.</p>');
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17043&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">BELL CHANNEL INN</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17045&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">ROYAL ISLANDER HOTEL</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17033&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">TAINO BEACH RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17042&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">CASTAWAYS RESORT AND SUITES</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17037&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">GRAND LUCAYAN RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17039&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">ISLAND SEAS RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17036&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">ISLAND PALM MARINA VILLAS CXL</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17034&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">MEMORIES ALL INCLUSIVE RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17040&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PELICAN BAY</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17032&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">FLAMINGO BAY HOTEL AND MARINA</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17038&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">GRAND LUCAYAN LIGHT HOUSE POINTE</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17043&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">BELL CHANNEL INN</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17045&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">ROYAL ISLANDER HOTEL</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17033&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">TAINO BEACH RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17042&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">CASTAWAYS RESORT AND SUITES</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17037&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">GRAND LUCAYAN RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17039&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">ISLAND SEAS RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17036&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">ISLAND PALM MARINA VILLAS CXL</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17034&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">MEMORIES ALL INCLUSIVE RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17040&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PELICAN BAY</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17032&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">FLAMINGO BAY HOTEL AND MARINA</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=17038&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">GRAND LUCAYAN LIGHT HOUSE POINTE</p></a>';
